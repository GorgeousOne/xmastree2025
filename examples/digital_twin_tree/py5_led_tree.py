...
from digital_twin_tree.orbit_cam import OrbitCamera
import digital_twin_tree.orbit_cam as oc

led_positions = []

def run_digital_tree(pixels, led_count):
	# sets up the Py5 sketch in order to draw an interactive display of the tree LEDs
	def settings():
	...
	def load_led_positions():
		# load the same coordinates for LEDs as dont in the examples
	...
	def draw_axes():
		py5.push_style()
		py5.stroke(255, 0, 0)
		py5.line(0, 0, 0, 50, 0, 0)
		py5.stroke(0, 255, 0)
		py5.line(0, 0, 0, 0, 0, 50)
		py5.stroke(0, 0, 255)
		py5.line(0, 0, 0, 0, 50, 0)
		py5.pop_style()
...
if __name__ == '__main__':
	# example tree rendering with blinking LEDs
	...
	p = Process(target=run_digital_tree, args=(shared_pixels, led_count))
	p.start()
